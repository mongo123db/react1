...
console.log(data.name)
  ...
  return (
    ...
    <button style={{backgroundColor:"green",color:"white",borderRadius:"20px",position:"fixed",bottom:"50px",left:"50px",padding:"7px"}} onClick={()=>{if( user.access==="admin"){ nav("/showadmin")};if(user.access==="user"){ nav("/show")}}} >&#60;&#60;home</button>
